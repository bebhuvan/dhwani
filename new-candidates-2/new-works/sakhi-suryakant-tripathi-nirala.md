...
The vocative “sakhi”—friend/confidante—structures a lyric mode in which meditation can become counsel, complaint, or confession. Nirala leverages the intimacy of address to stage conflicts of perception and duty without didacticism. Prosodic freedom supports quick turns of thought and tonal modulation.

## Edition Notes

- Reported year: 1935
- Source: https://archive.org/details/dli.ernet.522400
- Tracker notes: Hindi novel/poetry hybrid digitized by DLI. PD OK; no Dhwani duplicates. Pull imprint details for frontmatter citation.
- Tasks: verify title page and verso for publication facts; note translator/editor if applicable.

## About the Author

Nirala’s life and poetics are summarized under Anamika; Sakhi shows an earlier configuration of technique and theme within the Chhayavād frame.
...
- Choose a poem and mark each shift in address; what triggers it?
- Paraphrase images literally, then reconstruct the poem’s conceptual motion.
