---
title: "Charcha-Shatak"
author: ["Nathuram Premi"]
year: 1926
language: ["Hindi"]
genre: ["Essays", "Jain studies"]
...
sources:
  - name: "Source"
    url: "https://archive.org/details/in.ernet.dli.2015.340999"
    type: "archive"
references: []
...
An essay collection by Nathuram Premi (a prominent Jain scholar‑editor) engaging questions of literature, history, and doctrine in Hindi. The pieces balance documentation with argument, aimed at cultivated readers beyond a narrow specialist audience.

## Edition Notes

- Reported year: 1926
- Source: https://archive.org/details/in.ernet.dli.2015.340999
- Tracker notes: Hindi Jain literary critique (Jain Granth Ratnakar Karyalaya). PD OK (d.1960). Check for OCR availability and scan completeness.
- Tasks: verify title page and verso for publication facts; note translator/editor if applicable.

## About the Author

Nathuram Premi (1881–1960) edited, published, and wrote prolifically on Jain literary and historical subjects. His essays helped consolidate a modern Hindi Jain intellectual public.
...
- Topics: Jain textual history, biographies, literary critique, social questions—confirm ToC from the scan.
- Method: exposition grounded in citations; pedagogical tone with clear definitions.

## Significance

- Orientation to Jain studies for general Hindi readers; anchors later research and pedagogy.

## Editions & Sources

- Confirm imprint details and contributors (if multiple); extract index if present for names/terms.

## Reading Guide

- Choose one essay; list sources cited and reconstruct the argument flow.
 - Note editorial or typographic conventions that aid comprehension (headings, summaries).
