...
year: 1909
language: ["English"]
genre: ["Ethnology, Anthropology, Social History"]
description: "Multi-volume ethnographic encyclopedia documenting castes, tribes, customs, and social practices of South India. Detailed accounts of marriage customs, women's status, social hierarchies, and religious practices across different communities."
collections: ['new-candidates']
sources:
  - name: "Internet Archive"
    url: "https://archive.org/search.php?query=edgar+thurston+castes+tribes"
    type: "archive"
references: []
...
- Reported year: 1909
- Source: https://archive.org/search.php?query=edgar+thurston+castes+tribes
