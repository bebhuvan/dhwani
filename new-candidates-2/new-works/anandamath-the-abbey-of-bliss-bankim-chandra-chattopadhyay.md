---
title: "Anandamath (The Abbey of Bliss)"
author: ["Bankim Chandra Chattopadhyay"]
year: 1882
language: ["English"]
genre: ["Literature, Nationalism, Fiction"]
description: "Influential Bengali novel that inspired nationalist movement. Features 'Vande Mataram' (Hail Motherland), which became rallying cry for independence. Portrays Mother India as powerful feminine deity, elevating women's symbolic status in nationalist imagination."
collections: ['new-candidates']
sources:
  - name: "Internet Archive"
    url: "https://archive.org/search.php?query=anandamath+bankim"
    type: "archive"
references: []
...
- Reported year: 1882
- Source: https://archive.org/search.php?query=anandamath+bankim
