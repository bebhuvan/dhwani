...
description: A scholarly historical examination of Hinduism and Buddhism's origins,
  development, and mutual influence across Asia. Eliot's comprehensive analysis explores
  the philosophical foundations and geographical expansion of these major world religions.
...
- name: 'Wikipedia: Eliot'
  url: https://en.wikipedia.org/wiki/Eliot
  type: other
- name: 'Open Library: Hinduism and Buddhism, An Historical Sketch, Vol. 1'
  url: https://openlibrary.org/search?q=Hinduism+and+Buddhism%2C+An+Historical+Sketch%2C+Vol.+1
  type: other
- name: 'Wikipedia: Mahayana Buddhism'
...
- name: 'Wikipedia: Spread of Buddhism'
  url: https://en.wikipedia.org/wiki/Silk_Road_transmission_of_Buddhism
  type: other
- name: 'Wikipedia: Buddhism in Southeast Asia'
  url: https://en.wikipedia.org/wiki/Buddhism_in_Southeast_Asia
  type: other
featured: false
