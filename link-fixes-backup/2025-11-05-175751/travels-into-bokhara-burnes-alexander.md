...
description: 'Travels into Bokhara Volume 1 of 3: Being the Account of a Journey from
  India to Cabool, Tartary and Persia by Alexander Burnes is a work from the Indian
  literary tradition, available in the public domain. This entry includes links to
  all volumes of this multi-volume work.'
collections:
- classical-literature
sources:
