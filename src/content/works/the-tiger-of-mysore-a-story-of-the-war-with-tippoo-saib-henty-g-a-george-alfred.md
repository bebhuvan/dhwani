...
description: |
  G.A. Henty's "The Tiger of Mysore" (1895) exemplifies Victorian boys' adventure fiction set against the backdrop of the Fourth Anglo-Mysore War (1798-1799), culminating in the British East India Company's defeat and death of Tipu Sultan at Seringapatam. Henty, prolific author of over 140 historical adventure novels for young readers, constructed formulaic narratives combining historical events with fictional protagonists who witness and participate in pivotal moments, serving both as entertainment and as vehicles for inculcating imperial values, martial virtue, and racial hierarchies in British youth. The novel follows a British boy's adventures through Tipu Sultan's Mysore, presenting the Mysorean ruler as simultaneously noble savage and oriental despot, brave but cruel, worthy opponent but ultimate threat requiring British intervention. Henty's fiction operated as pedagogy, teaching generations of British boys their place in imperial hierarchy while naturalizing conquest through adventure narrative's pleasures. The work portrays the Anglo-Mysore Wars through explicitly partisan lens: British expansion appears as civilizing mission, Tipu's resistance as fanatical tyranny, and the final siege of Seringapatam as triumph of superior British character and military skill. Historical scholarship now recognizes Tipu Sultan as sophisticated ruler who modernized Mysore's administration, economy, and military while resisting East India Company expansion, making Henty's caricature both politically motivated and historically reductive. The novel's significance lies less in historical accuracy than in its function as imperial propaganda for juvenile readers, exemplifying how adventure fiction served British imperialism by constructing heroic narratives of conquest that obscured violence, exploitation, and resistance. As cultural artifact, "The Tiger of Mysore" reveals Victorian imperial ideology at its most accessible and insidious—entertaining stories that shaped boyhood imaginaries, normalizing empire as natural theater for British masculine achievement while rendering colonized peoples as either loyal subordinates or savage antagonists requiring subjugation.
  
collections:
- modern-literature
sources:
- name: 'Project Gutenberg'
  url: https://www.gutenberg.org/ebooks/18813
  type: other
- name: 'Project Gutenberg (HTML)'
  url: https://www.gutenberg.org/ebooks/18813.html.images
  type: other
- name: 'Internet Archive (The tiger of Mysore : a story of the war with Tippoo Saib)'
  url: https://archive.org/details/31383050696239
  type: other
- name: 'Internet Archive (The tiger of Mysore; a story of the war with Tippoo Saib)'
  url: https://archive.org/details/tigerofmysoresto00hent
  type: other
references:
- name: 'Wikipedia: The Tiger of Mysore'
  url: https://en.wikipedia.org/wiki/The_Tiger_of_Mysore
  type: other
- name: 'Wikipedia: Henty'
  url: https://en.wikipedia.org/wiki/Henty
  type: other
- name: 'Open Library: The Tiger of Mysore: A Story of the War with Tippoo Saib'
  url: https://openlibrary.org/search?q=The%20Tiger%20of%20Mysore%3A%20A%20Story%20of%20the%20War%20with%20Tippoo%20Saib%20Henty%2C%20G.%20A.%20%28George%20Alfred%29
  type: other
featured: false
...
1. British-Mysorean conflict and cultural tensions
2. Individual heroism within larger historical processes
3. Representations of indigenous resistance and colonial power
4. Martial skill and cultural superiority as imperial narratives
...
1. Introductory chapters establishing protagonist and historical context
2. Detailed descriptions of military encounters
3. Interpersonal drama illustrating cultural interactions
4. Climactic scenes of British military triumph
