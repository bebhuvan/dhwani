...
genre:
  ...
  - Advaita Vedanta
description: |
  Sureshvaracharya's foundational 8th-century Advaita Vedanta treatise comprises 423 verses arguing that liberation is attained through self-knowledge rather than ritual action. One of Adi Shankara's four principal disciples and first pontiff of Sringeri Sharada Peetham, Sureshvaracharya systematically develops this argument across four chapters addressing ignorance, Self versus not-self, and the mahavakya "tat tvam asi." This Hindi translation with original Sanskrit makes the text accessible to modern readers, representing one of four most important works in Advaita siddhi-literature tradition.
collections:
  - religious-texts
  - classical-literature
sources:
  - name: 'Internet Archive: With Hindi Translation'
    url: https://archive.org/details/Naishkarmya-Siddhi.by.Sureshvaracharya.With.Hindi.Translation
    type: other
  - name: 'Internet Archive: With Chandrika Commentary (Sanskrit)'
    url: https://archive.org/details/Naishkarmya-Siddhi.by.Sureshvaracharya.with.Chandrika.of.Jnanottama.Sanskrit
    type: other
  - name: 'Internet Archive: DLI Bombay Sanskrit Series XXXVIII (1906)'
    url: https://archive.org/details/in.ernet.dli.2015.279721
    type: other
  - name: 'Internet Archive: DLI Bhandarkar Oriental Research Institute (1925)'
    url: https://archive.org/details/in.ernet.dli.2015.284189
    type: other
  - name: 'Internet Archive: English Translation by A. J. Alston'
    url: https://archive.org/details/naiskarmyasiddhi_201510
    type: other
references:
  - name: 'Wikipedia: Naishkarmya Siddhi'
    url: https://en.wikipedia.org/wiki/Naishkarmya_Siddhi
    type: wikipedia
  - name: 'Wikipedia: Sureśvara'
    url: https://en.wikipedia.org/wiki/Sure%C5%9Bvara
    type: wikipedia
  ...
  - name: 'Wikipedia: Advaita Vedanta'
    ...
    type: wikipedia
  - name: 'Open Library: Naishkarmya Siddhi'
    url: https://openlibrary.org/works/OL394579W/Nais%CC%A3karmyadiddhih%CC%A3
    type: other
  - name: 'Sringeri Sharada Peetham: Sri Sureshwaracharya'
    url: https://www.sringeri.net/jagadgurus/sri-sureshwaracharya
    type: other
  - name: 'Sringeri Sharada Peetham: Works of Sri Sureshwaracharya'
    url: https://www.sringeri.net/jagadgurus/sri-sureshwaracharya/works-of-sri-sureshwaracharya
    type: other
featured: false
