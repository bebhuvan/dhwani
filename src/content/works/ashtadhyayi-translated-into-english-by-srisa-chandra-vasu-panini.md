...
genre:
  ...
  - Ancient Literature
description: >-
  Emerging during the vibrant intellectual climate of the Late Vedic Period (c.
  500-200 BCE), Panini's Ashtadhyayi was composed in the northwestern region of
  ancient India, likely in Gandhara, during a time of significant scholarly and
...
references:
  ...
  - name: 'Open Library: Panini''s Ashtadhyayi'
    url: >-
      https://openlibrary.org/search?q=Paninis+Ashtadhyayi+The+Sanskrit+Grammar+year+Panini
    type: other
featured: false
...
- [Internet Archive (Vasu Translation)](https://archive.org/details/ashtadhyayitrans06paniuoft)
- [Internet Archive (Sanskrit Text)](https://archive.org/details/in.ernet.dli.2015.22683)

Additional reference materials:

- [Wikipedia: Ashtadhyayi](https://en.wikipedia.org/wiki/Ashtadhyayi)
- [Wikipedia: Panini](https://en.wikipedia.org/wiki/Panini)
- [Wikipedia: Srisa Chandra Vasu](https://en.wikipedia.org/wiki/Sris_Chandra_Basu)
