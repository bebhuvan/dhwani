...
genre:
  ...
  - Cultural Study
description: >-
  Published in 1908, Flora Annie Steel's "India Through the Ages" represents a
  significant early 20th-century British scholarly attempt to comprehensively
  document Indian historical and cultural evolution. Drawing from multiple
  colonial-era scholarly sources, the work synthesizes an extensive narrative
  spanning from hypothetical Aryan migrations through the complex trajectories
  of ancient, medieval, and early modern Indian civilizations, culminating in
  the Mughal Empire's gradual decline.
collections:
...
references:
  ...
  - name: 'Open Library: India Through the Ages'
    url: >-
      https://openlibrary.org/search?q=India+Through+the+Ages+Steel&mode=everything
    type: other
featured: false
