...
genre:
  ...
  - Philosophy
description: >-
  The Laṅkāvatāra Sūtra emerges as a seminal philosophical text within the
  complex intellectual landscape of late classical Indian Buddhism, representing
  a sophisticated articulation of Mahayana metaphysical thought during the Gupta
  period's remarkable scholarly renaissance (circa 4th-5th centuries CE).
  Compiled by an anonymous collective of Buddhist scholars, this profound
  scripture encapsulates critical philosophical innovations that fundamentally
  transformed understanding of consciousness, perception, and ontological
  reality.
collections:
  - ancient-wisdom
  - buddhist-texts
...
references:
  ...
  - name: Open Library
    url: >-
      https://openlibrary.org/search?q=Lankavatara+Sutra+Sanskrit&mode=everything
    type: other
featured: false
