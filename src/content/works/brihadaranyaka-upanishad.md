...
genre:
  ...
  - Ancient Wisdom
description: >-
  The Brihadaranyaka Upanishad stands as the oldest, longest, and most
  philosophically profound Upanishad, exploring ultimate reality (Brahman), the
  self (Atman), consciousness, creation, and liberation through dialogues
  between sages and seekers. Composed around 700 BCE, this text of six chapters
  presents foundational Vedantic philosophy: the famous 'neti neti' (not this,
  not this) method for understanding Brahman through negation, Yajnavalkya's
  brilliant philosophical debates establishing Atman-Brahman identity,
  cosmological speculations on creation from primordial unity, and meditation
...
references:
  ...
  - name: 'Open Library: Brihadaranyaka Upanishad year'
    url: >-
      https://openlibrary.org/search?q=Brihadaranyaka+Upanishad+year+-700+language+Sanskrit+Various+Sages
    type: other
featured: true
