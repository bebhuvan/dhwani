...
genre:
  - Reference Work
description: >-
  A Grammar of the Hindustani Language by John Shakespear represents a critical
  linguistic documentation of the language during the early 19th century British
  colonial period in India. Published in 1813, the work emerges during a pivotal
  moment of linguistic documentation and cultural encounter between British
  colonial administrators and Indian linguistic traditions.
collections:
  - spiritual-texts
sources:
...
references:
  ...
  - name: 'Open Library: A Grammar of the'
    url: >-
      https://openlibrary.org/search?q=A+Grammar+of+the+Hindustani+Language+John+Shakespear
    type: other
featured: false
