...
description: >-
  T. Gowing's "A Soldier's Experience" represents a critical first-hand
  historical account of British imperial military operations in mid-19th century
  colonial India, offering an unfiltered perspective from within the military
  ranks during a pivotal period of imperial expansion and internal conflict.
sources:
...
references:
  - name: 'Wikipedia: A Soldier''s Experience; or, A Voice from the Ranks'
    url: >-
      https://en.wikipedia.org/wiki/A_Soldier%27s_Experience%3B_or%2C_A_Voice_from_the_Ranks
    type: other
