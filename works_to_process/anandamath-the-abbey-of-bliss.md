...
- Tracker notes: Influential Bengali novel that inspired nationalist movement. Features 'Vande Mataram' (Hail Motherland), which became rallying cry for independence. Portrays Mother India as powerful feminine deity, elevating women's symbolic status in nationalist imagination.
