---
title: "Jayanti Utsargo"
author: ["Charu Chandra Bhattacharya"]
year: 1931
language: ["Bengali"]
genre: ["Commemorative volume", "Essays"]
...
Commemorative volumes (‘utsarga’) typically gather essays and selections honoring a figure or movement. This entry treats the book as an editorial artifact: its value lies in how it curates memory and scholarship for a general public.

## Edition Notes

- Reported year: 1931
- Source: https://archive.org/details/in.ernet.dli.2015.291008
- Tracker notes: Bengali commemorative volume (Rabindra Parichoy Sabha). PD OK (d.1961); confirm suitability (anthology). Needs ToC review.
- Tasks: verify title page and verso for publication facts; note translator/editor if applicable.

## About the Editor/Contributor

Charu Chandra Bhattacharya is represented in this batch as a science writer; here he likely appears as contributor or editor within a commemorative context. Confirm precise role from the scan.
...
## Editorial & Rights Assessment
 
- Identify all contributors and confirm that each contribution is PD in India (death year or first publication year).
- If the volume reprints earlier texts, verify their PD status separately.
 
## The Work (as anthology)
 
- Organization: preface with rationale; sections by theme or period; contributions by scholars/peers.
- Apparatus: inclusion of lists, photographs, letters, or bibliographies (to be verified).
 
## Significance
 
- Documents how literary communities remember and teach a figure or movement.
- Serves as a waypoint between periodicals and monographs for public pedagogy.
 
## Reading Guide
 
- Select one essay and outline claims/evidence; assess tone (commemorative vs. analytic).
