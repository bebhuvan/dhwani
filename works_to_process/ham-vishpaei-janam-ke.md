...
sources:
  - name: "Source"
    url: "https://archive.org/details/in.ernet.dli.2015.479527"
    type: "archive"
references: []
...
A collection by Bal Krishna Sharma ‘Naveen’, a significant poet whose work bridges Chhayavād lyricism and progressively sharper social textures. The idiom balances musicality with directness; stanza forms vary to accommodate reflection, satire, and lament.

## Edition Notes

- Reported year: 1946
- Source: https://archive.org/details/in.ernet.dli.2015.479527
- Tracker notes: Hindi poetry collection (Uttar Chand Kapoor & Sons). PD OK (d.1960). Confirm scan completeness (duplicate IA entry) and obtain ToC/themes.
- Tasks: verify title page and verso for publication facts; note translator/editor if applicable.

## About the Author

Bal Krishna Sharma ‘Naveen’ (1897–1960) was a Hindi poet, editor, and public figure. His verse registers nationalist fervor, ethical exhortation, and private sorrow without surrendering to rhetoric; he stands at a crossroads between high lyric and civic poetry.
...
Poems of the 1940s engaged political transition, scarcity, and the problem of collective responsibility. ‘Naveen’ adapts Chhayavād’s inner music to a more public idiom.

## The Work

- Voice: rousing yet introspective when required; clear ethical address without programmatic schemes.
- Form: regular meters alternate with freer measures; refrain used for emphasis.
- Themes: dignity of labour, responsibility of leadership, endurance and hope.

## Significance

- Model of civic lyric in mid‑century Hindi; useful for tracing a spectrum from private to public voice.

## Editions & Sources

- Confirm imprint details; extract poem list and any dates of composition if printed.

## Reading Guide

- Scan for how refrain operates structurally; what does it return us to?
- Identify diction shifts between exhortation and vulnerability; mark where they occur.
